...
.font-mono,[font-mono=""]{font-family:'Fira Code', monospace;}
.text-lg,[text-lg=""]{font-size:1.125rem;line-height:1.75rem;}
[text-sm=""],.text-sm,[text~="sm"]{font-size:0.875rem;line-height:1.25rem;}
.dark [text~="dark\:gray3"]{--un-text-opacity:1;color:rgba(212,212,216,var(--un-text-opacity));}
.hover\:text-red:hover{--un-text-opacity:1;color:rgba(248,113,113,var(--un-text-opacity));}
.text-teal5,[text-teal5=""]{--un-text-opacity:1;color:rgba(20,184,166,var(--un-text-opacity));}
[text~="gray5"]{--un-text-opacity:1;color:rgba(113,113,122,var(--un-text-opacity));}
.italic,[italic=""]{font-style:italic;}
[flex~="col"]{flex-direction:column;}
.flex-auto,[flex-auto=""]{flex:1 1 auto;}
[flex=""],.flex,[flex~="\~"]{display:flex;}
[grid=""],.grid,[grid~="\~"]{display:grid;}
[grid-cols-2=""],.grid-cols-2,[grid~="cols-2"]{grid-template-columns:repeat(2, minmax(0, 1fr));}
[grid~="cols-4"]{grid-template-columns:repeat(4, minmax(0, 1fr));}
[grid~="cols-\[1fr\2c 4fr\]"]{grid-template-columns:1fr 4fr;}
[grid~="rows-\[max-content\2c 1fr\]"]{grid-template-rows:max-content 1fr;}
.gap-3,[flex~="gap-3"]{grid-gap:0.75rem;gap:0.75rem;}
.gap-4,[grid~="gap-4"]{grid-gap:1rem;gap:1rem;}
.relative,[relative=""]{position:relative;}
.h-full,[h-full=""]{height:100%;}
[h~="\31 \.3em"]{height:1.3em;}
