...
var require_detect_libc = __commonJS({
  "node_modules/detect-libc/lib/detect-libc.js"(exports, module) {
    "use strict";
    var platform = (init_os(), os_exports).platform();
    var spawnSync = (init_child_process(), child_process_exports).spawnSync;
    var readdirSync = (init_fs(), fs_exports).readdirSync;
    var GLIBC = "glibc";
    var MUSL = "musl";
    var spawnOptions = {
      encoding: "utf8",
...
var require_input = __commonJS({
  "node_modules/sharp/lib/input.js"(exports, module) {
    ...
    function _inputOptionsFromObject(obj) {
      ...
      return [raw, density, limitInputPixels, sequentialRead, failOnError, animated, page, pages, subifd].some(is.defined) ? { raw, density, limitInputPixels, sequentialRead, failOnError, animated, page, pages, subifd } : void 0;
    }
...
var require_output = __commonJS({
  "node_modules/sharp/lib/output.js"(exports, module) {
    ...
    function avif(options) {
      return this.heif(__spreadProps(__spreadValues({}, options), { compression: "av1" }));
    }
...
var require_utility = __commonJS({
  "node_modules/sharp/lib/utility.js"(exports, module) {
    "use strict";
    var events = (init_events(), events_exports);
    var detectLibc = require_detect_libc();
    var is = require_is();
    var platformAndArch = require_platform()();
    var sharp = require_sharp();
...
// dep:svimg__sharp
var svimg_sharp_default = require_lib();
export {
  svimg_sharp_default as default
};
//# sourceMappingURL=svimg__sharp.js.map
