...
date: 2023-03-05
description:  Sometimes selfhosting has issue of not being able to expose your ports to the internet behind modem or router. 
              In this article we will learn how to reroute traffic for polkadot p2p port through a VPN tunnel using WireGuard.
tags:
  - WireGuard
  - VPN
---
