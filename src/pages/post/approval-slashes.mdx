...
import DotValidatorStake from '~/components/DotValidatorStake.svelte';
...
destroy you, but large enough to hurt. With validators typically staking around <DotValidatorStake
client:load showMinStake={true} />, a 2% slash represents <DotValidatorStake client:load
showSlashAmount={true} slashPercentage={2} /> at current prices of <DotValidatorStake client:load
showPrice={true} /> per DOT.
...
<DotValidatorStake stakeAmount={100000} /> and your validator messes up, you lose
<DotValidatorStake client:load showSlashAmount={true} slashPercentage={2} stakeAmount={100000} /> –
