...
tags:
  ...
  - blockchain
---
import CompareImages from '~/components/CompareImages.svelte'
...
<CompareImages
  imageLeftSrc="/assets/post/kappa-sigma-mu-society/ksm-layer-1.webp" 
  imageRightSrc="/assets/post/kappa-sigma-mu-society/ksm-layer-2.webp" 
  />
