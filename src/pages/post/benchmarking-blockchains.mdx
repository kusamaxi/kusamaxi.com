...
draft: false
title: Benchmarking Blockchains
date: 2023-03-28
description: Assessing Google Epyc 7003 C2D Milan processors using Polkadot client and Fio for high single-thread performance in blockchains.
tags:
- benchmark
- blockchain
- latency
...
Best option for running blockchains seems to be bare metal servers running on latest AMD mobile processors like 7045HX
unfortunately only available to OEMs. For the comparison we recommend you to read our article on [building 1000$ validator](https://kusamaxi.com/post/building-hosting-validator).
