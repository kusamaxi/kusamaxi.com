...
failure modes. A single successful attack vector compromises everything. Meanwhile diverse systems
maintain adaptation capacity through redundancy - some approaches fail, others survive, the system
persists.
...
energy gradients. Five orders of magnitude more compute capacity and we're boiling oceans. The
universe's thermodynamic limits apply equally to superintelligence. Perfect optimization without
waste or competition exhausts available gradients faster.

The framework doesn't require altruism or cooperation. Even purely self-interested agents benefit
from maintaining these conditions. Defection offers short-term gains but long-term stagnation. The
principles select for themselves through fitness landscapes where violation becomes self-defeating.
